...
public final class HologramArgument<C> extends CommandArgument<C, Clan> {
    ...
    private HologramArgument(
        ...
        super(required, name, new HologramParser<>(), defaultValue, Clan.class, suggestionsProvider);
    }

    public static final class HologramParser<C> implements ArgumentParser<C, Clan> {
        ...
        public @NotNull ArgumentParseResult<Clan> parse(
            ...
            Clan hologram = ClanAPI.get().find(input).orElse(null);
        ...
        public @NotNull List<String> suggestions(
            ...
            ClanAPI.get().holograms().stream().filter(holo -> holo.name() != null)
